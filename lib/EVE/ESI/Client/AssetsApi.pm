...
#
package EVE::ESI::Client::AssetsApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_assets' } = { 
    	summary => 'Get character assets',
        params => $params,
        returns => 'ARRAY[GetCharactersCharacterIdAssets200Ok]',
        };
}
# @return ARRAY[GetCharactersCharacterIdAssets200Ok]
#
sub get_characters_character_id_assets {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_assets");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/assets/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetCharactersCharacterIdAssets200Ok]', $response);

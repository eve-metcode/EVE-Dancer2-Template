...
#
package EVE::ESI::Client::PlanetaryInteractionApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_planets' } = { 
    	summary => 'Get colonies',
        params => $params,
        returns => 'ARRAY[GetCharactersCharacterIdPlanets200Ok]',
        };
}
# @return ARRAY[GetCharactersCharacterIdPlanets200Ok]
#
sub get_characters_character_id_planets {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_planets");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/planets/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetCharactersCharacterIdPlanets200Ok]', $response);
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_planets_planet_id' } = { 
    	summary => 'Get colony layout',
        params => $params,
        returns => 'GetCharactersCharacterIdPlanetsPlanetIdOk',
        };
}
# @return GetCharactersCharacterIdPlanetsPlanetIdOk
#
sub get_characters_character_id_planets_planet_id {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_planets_planet_id");
    }

    # verify the required parameter 'planet_id' is set
    unless (exists $args{'planet_id'}) {
      croak("Missing the required parameter 'planet_id' when calling get_characters_character_id_planets_planet_id");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/planets/{planet_id}/';
    ...
    my $_response_object = $self->{api_client}->deserialize('GetCharactersCharacterIdPlanetsPlanetIdOk', $response);
    return $_response_object;
}
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_universe_schematics_schematic_id' } = { 
    	summary => 'Get schematic information',
        params => $params,
        returns => 'GetUniverseSchematicsSchematicIdOk',
        };
}
# @return GetUniverseSchematicsSchematicIdOk
#
sub get_universe_schematics_schematic_id {
    my ($self, %args) = @_;

    # verify the required parameter 'schematic_id' is set
    unless (exists $args{'schematic_id'}) {
      croak("Missing the required parameter 'schematic_id' when calling get_universe_schematics_schematic_id");
    }

    # parse inputs
    my $_resource_path = '/universe/schematics/{schematic_id}/';
    ...
    # path params
    if ( exists $args{'schematic_id'}) {
        my $_base_variable = "{" . "schematic_id" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'schematic_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('GetUniverseSchematicsSchematicIdOk', $response);
    return $_response_object;
}

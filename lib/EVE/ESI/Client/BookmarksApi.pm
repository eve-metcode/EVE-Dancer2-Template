...
#
package EVE::ESI::Client::BookmarksApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_bookmarks' } = { 
    	summary => 'List bookmarks',
        params => $params,
        returns => 'ARRAY[GetCharactersCharacterIdBookmarks200Ok]',
        };
}
# @return ARRAY[GetCharactersCharacterIdBookmarks200Ok]
#
sub get_characters_character_id_bookmarks {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_bookmarks");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/bookmarks/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetCharactersCharacterIdBookmarks200Ok]', $response);
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_bookmarks_folders' } = { 
    	summary => 'List bookmark folders',
        params => $params,
        returns => 'ARRAY[GetCharactersCharacterIdBookmarksFolders200Ok]',
        };
}
# @return ARRAY[GetCharactersCharacterIdBookmarksFolders200Ok]
#
sub get_characters_character_id_bookmarks_folders {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_bookmarks_folders");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/bookmarks/folders/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetCharactersCharacterIdBookmarksFolders200Ok]', $response);
    return $_response_object;
}

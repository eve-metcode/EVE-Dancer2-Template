...
#
package EVE::ESI::Client::ClonesApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_clones' } = { 
    	summary => 'Get clones',
        params => $params,
        returns => 'GetCharactersCharacterIdClonesOk',
        };
}
# @return GetCharactersCharacterIdClonesOk
#
sub get_characters_character_id_clones {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_clones");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/clones/';
    ...
    my $_response_object = $self->{api_client}->deserialize('GetCharactersCharacterIdClonesOk', $response);

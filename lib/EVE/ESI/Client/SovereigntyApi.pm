...
#
package EVE::ESI::Client::SovereigntyApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_sovereignty_campaigns' } = { 
    	summary => 'List sovereignty campaigns',
        params => $params,
        returns => 'ARRAY[GetSovereigntyCampaigns200Ok]',
        };
}
# @return ARRAY[GetSovereigntyCampaigns200Ok]
#
sub get_sovereignty_campaigns {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/sovereignty/campaigns/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetSovereigntyCampaigns200Ok]', $response);
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_sovereignty_map' } = { 
    	summary => 'List sovereignty of systems',
        params => $params,
        returns => 'ARRAY[GetSovereigntyMap200Ok]',
        };
}
# @return ARRAY[GetSovereigntyMap200Ok]
#
sub get_sovereignty_map {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/sovereignty/map/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetSovereigntyMap200Ok]', $response);
    return $_response_object;
}
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_sovereignty_structures' } = { 
    	summary => 'List sovereignty structures',
        params => $params,
        returns => 'ARRAY[GetSovereigntyStructures200Ok]',
        };
}
# @return ARRAY[GetSovereigntyStructures200Ok]
#
sub get_sovereignty_structures {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/sovereignty/structures/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetSovereigntyStructures200Ok]', $response);
    return $_response_object;
}

...
#
package EVE::ESI::Client::Object::GetOpportunitiesGroupsGroupIdOk;
...
__PACKAGE__->swagger_types( {
    'connected_groups' => 'ARRAY[int]',
    'description' => 'string',
    'group_id' => 'int',
    'name' => 'string',
    'notification' => 'string',
    'required_tasks' => 'ARRAY[int]'
} );

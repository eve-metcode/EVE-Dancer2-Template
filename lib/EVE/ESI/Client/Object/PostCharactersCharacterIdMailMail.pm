...
#
package EVE::ESI::Client::Object::PostCharactersCharacterIdMailMail;
...
__PACKAGE__->class_documentation({description => 'mail schema',
...
__PACKAGE__->method_documentation({
    ...
    'recipients' => {
    	datatype => 'ARRAY[PostCharactersCharacterIdMailRecipient]',

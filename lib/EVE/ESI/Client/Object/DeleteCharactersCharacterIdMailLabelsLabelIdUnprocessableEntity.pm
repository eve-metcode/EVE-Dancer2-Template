...
#
package EVE::ESI::Client::Object::DeleteCharactersCharacterIdMailLabelsLabelIdUnprocessableEntity;
...
__PACKAGE__->class_documentation({description => 'Unprocessable entity',

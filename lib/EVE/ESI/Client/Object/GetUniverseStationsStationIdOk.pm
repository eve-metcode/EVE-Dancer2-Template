...
#
package EVE::ESI::Client::Object::GetUniverseStationsStationIdOk;
...
__PACKAGE__->method_documentation({
    'max_dockable_ship_volume' => {
    	datatype => 'double',
    	base_name => 'max_dockable_ship_volume',
    ...
    'position' => {
    	datatype => 'GetUniverseStationsStationIdPosition',
    	base_name => 'position',
    	description => '',
    	format => '',
    	read_only => '',
    ...
    'reprocessing_efficiency' => {
    	datatype => 'double',
    	base_name => 'reprocessing_efficiency',
    ...
    'reprocessing_stations_take' => {
    	datatype => 'double',
    	base_name => 'reprocessing_stations_take',

...
#
package EVE::ESI::Client::Object::GetLoyaltyStoresCorporationIdOffers200Ok;
...
__PACKAGE__->method_documentation({
    ...
    'required_items' => {
    	datatype => 'ARRAY[GetLoyaltyStoresCorporationIdOffersRequiredItem]',
    	base_name => 'required_items',

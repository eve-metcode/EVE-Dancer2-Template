...
#
package EVE::ESI::Client::Object::GetUniverseTypesTypeIdOk;
...
__PACKAGE__->method_documentation({
    ...
    'dogma_attributes' => {
    	datatype => 'ARRAY[GetUniverseTypesTypeIdDogmaAttribute]',
    	base_name => 'dogma_attributes',
    	description => 'dogma_attributes array',
    	format => '',
    	read_only => '',
    		},
    'dogma_effects' => {
    	datatype => 'ARRAY[GetUniverseTypesTypeIdDogmaEffect]',
    	base_name => 'dogma_effects',

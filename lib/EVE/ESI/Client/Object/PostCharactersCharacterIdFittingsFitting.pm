...
#
package EVE::ESI::Client::Object::PostCharactersCharacterIdFittingsFitting;
...
__PACKAGE__->class_documentation({description => 'fitting object',
...
__PACKAGE__->method_documentation({
    ...
    'items' => {
    	datatype => 'ARRAY[PostCharactersCharacterIdFittingsItem]',
    	base_name => 'items',

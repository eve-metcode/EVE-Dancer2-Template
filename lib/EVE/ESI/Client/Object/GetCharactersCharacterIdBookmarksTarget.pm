...
#
package EVE::ESI::Client::Object::GetCharactersCharacterIdBookmarksTarget;
...
__PACKAGE__->class_documentation({description => 'target object',
...
__PACKAGE__->method_documentation({
    'coordinates' => {
    	datatype => 'GetCharactersCharacterIdBookmarksCoordinates',
    ...
    'item' => {
    	datatype => 'GetCharactersCharacterIdBookmarksItem',
    	base_name => 'item',
    	description => '',
    	format => '',
    	read_only => '',

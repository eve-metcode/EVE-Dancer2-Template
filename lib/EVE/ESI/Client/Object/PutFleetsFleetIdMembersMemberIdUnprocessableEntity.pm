...
#
package EVE::ESI::Client::Object::PutFleetsFleetIdMembersMemberIdUnprocessableEntity;
...
__PACKAGE__->class_documentation({description => '422 unprocessable entity object',

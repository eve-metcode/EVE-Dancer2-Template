...
#
package EVE::ESI::Client::Object::GetUniverseStargatesStargateIdOk;
...
__PACKAGE__->method_documentation({
    'destination' => {
    	datatype => 'GetUniverseStargatesStargateIdDestination',
    ...
    'position' => {
    	datatype => 'GetUniverseStargatesStargateIdPosition',
    	base_name => 'position',
    	description => '',
    	format => '',
    	read_only => '',

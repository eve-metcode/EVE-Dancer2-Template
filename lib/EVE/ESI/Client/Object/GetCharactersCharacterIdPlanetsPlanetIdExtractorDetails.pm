...
#
package EVE::ESI::Client::Object::GetCharactersCharacterIdPlanetsPlanetIdExtractorDetails;
...
__PACKAGE__->class_documentation({description => 'extractor_details object',
...
__PACKAGE__->method_documentation({
    ...
    'head_radius' => {
    	datatype => 'double',
    	base_name => 'head_radius',
    	description => 'head_radius number',
    	format => '',
    	read_only => '',
    		},
    'heads' => {
    	datatype => 'ARRAY[GetCharactersCharacterIdPlanetsPlanetIdHead]',
    	base_name => 'heads',

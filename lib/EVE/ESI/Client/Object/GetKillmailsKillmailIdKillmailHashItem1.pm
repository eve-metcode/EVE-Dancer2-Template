...
#
package EVE::ESI::Client::Object::GetKillmailsKillmailIdKillmailHashItem1;
...
__PACKAGE__->class_documentation({description => 'item object',
...
__PACKAGE__->method_documentation({
    ...
    'item_type_id' => {
    	datatype => 'int',
    	base_name => 'item_type_id',
    	description => 'item_type_id integer',
    	format => '',
    	read_only => '',
    		},
    'items' => {
    	datatype => 'ARRAY[GetKillmailsKillmailIdKillmailHashItem]',
    	base_name => 'items',

...
#
package EVE::ESI::Client::Object::GetCharactersCharacterIdSearchOk;
...
__PACKAGE__->swagger_types( {
    ...
    'alliance' => 'ARRAY[int]',
    'character' => 'ARRAY[int]',
    'constellation' => 'ARRAY[int]',
    'corporation' => 'ARRAY[int]',
    'faction' => 'ARRAY[int]',
    'inventorytype' => 'ARRAY[int]',
    'region' => 'ARRAY[int]',
    'solarsystem' => 'ARRAY[int]',
    'station' => 'ARRAY[int]',
    'structure' => 'ARRAY[int]',
    'wormhole' => 'ARRAY[int]'
} );

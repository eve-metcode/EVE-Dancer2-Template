...
#
package EVE::ESI::Client::Object::GetUniverseSystemsSystemIdOk;
...
__PACKAGE__->method_documentation({
    ...
    'planets' => {
    	datatype => 'ARRAY[GetUniverseSystemsSystemIdPlanet]',
    	base_name => 'planets',
    ...
    'position' => {
    	datatype => 'GetUniverseSystemsSystemIdPosition',
    	base_name => 'position',
    	description => '',
    	format => '',
    	read_only => '',

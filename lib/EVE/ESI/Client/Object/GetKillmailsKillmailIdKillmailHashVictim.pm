...
#
package EVE::ESI::Client::Object::GetKillmailsKillmailIdKillmailHashVictim;
...
__PACKAGE__->class_documentation({description => 'victim object',
...
__PACKAGE__->method_documentation({
    ...
    'faction_id' => {
    	datatype => 'int',
    	base_name => 'faction_id',
    	description => 'faction_id integer',
    	format => '',
    	read_only => '',
    		},
    'items' => {
    	datatype => 'ARRAY[GetKillmailsKillmailIdKillmailHashItem1]',
    	base_name => 'items',
    ...
    'position' => {
    	datatype => 'GetKillmailsKillmailIdKillmailHashPosition',
    	base_name => 'position',
    	description => '',
    	format => '',
    	read_only => '',

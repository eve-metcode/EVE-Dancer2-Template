...
#
package EVE::ESI::Client::Object::GetCharactersCharacterIdCalendarEventIdOk;
...
__PACKAGE__->class_documentation({description => 'Full details of a specific event',

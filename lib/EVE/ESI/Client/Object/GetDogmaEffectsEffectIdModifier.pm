...
#
package EVE::ESI::Client::Object::GetDogmaEffectsEffectIdModifier;
...
__PACKAGE__->class_documentation({description => 'modifier object',
...
__PACKAGE__->method_documentation({
    ...
    'modified_attribute_id' => {
    	datatype => 'int',
    	base_name => 'modified_attribute_id',
    ...
    'modifying_attribute_id' => {
    	datatype => 'int',
    	base_name => 'modifying_attribute_id',

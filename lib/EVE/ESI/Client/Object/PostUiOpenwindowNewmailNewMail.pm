...
#
package EVE::ESI::Client::Object::PostUiOpenwindowNewmailNewMail;
...
__PACKAGE__->class_documentation({description => 'new_mail object',
...
__PACKAGE__->method_documentation({
    ...
    'to_corp_or_alliance_id' => {
    	datatype => 'int',
    	base_name => 'to_corp_or_alliance_id',

...
#
package EVE::ESI::Client::Object::GetCharactersCharacterIdSkillsSkill;
...
__PACKAGE__->class_documentation({description => 'skill object',
...
__PACKAGE__->method_documentation({
    ...
    'skillpoints_in_skill' => {
    	datatype => 'int',
    	base_name => 'skillpoints_in_skill',

...
#
package EVE::ESI::Client::Object::GetKillmailsKillmailIdKillmailHashOk;
...
__PACKAGE__->method_documentation({
    'attackers' => {
    	datatype => 'ARRAY[GetKillmailsKillmailIdKillmailHashAttacker]',
    	base_name => 'attackers',
    ...
    'victim' => {
    	datatype => 'GetKillmailsKillmailIdKillmailHashVictim',
    	base_name => 'victim',
    	description => '',
    	format => '',
    	read_only => '',

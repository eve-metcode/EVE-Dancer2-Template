...
#
package EVE::ESI::Client::Object::GetUniverseFactions200Ok;
...
__PACKAGE__->method_documentation({
    ...
    'militia_corporation_id' => {
    	datatype => 'int',
    	base_name => 'militia_corporation_id',
    ...
    'station_system_count' => {
    	datatype => 'int',
    	base_name => 'station_system_count',

...
has _cfg => ( is => 'ro',
              isa => 'EVE::ESI::Client::Configuration',
              default => sub { EVE::ESI::Client::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'EVE Swagger Interface',
                          app_version => '0.4.2.dev22',
...
sub _build_af {
	...
	return EVE::ESI::Client::ApiFactory->new(%args);
}

=head1 NAME

EVE::ESI::Client::Role - a Moose role for the EVE Swagger Interface

=head2 EVE Swagger Interface version: 0.4.2.dev22
...
EVE::ESI::Client::ApiFactory for non-Moosey usage.
...
The tokens will be placed in a L<EVE::ESI::Client::Configuration> instance
...
Returns an API factory object. You probably won't need to call this directly.
        ...
        $self->api_factory('Pet'); # returns a EVE::ESI::Client::PetApi instance

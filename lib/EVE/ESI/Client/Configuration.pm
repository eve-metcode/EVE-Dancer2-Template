...
#
package EVE::ESI::Client::Configuration;
...
=head1 Name
        ...
        EVE::ESI::Client::Configuration - holds the configuration for all EVE::ESI::Client Modules
...
sub new {
	...
	# base_url
        $p{base_url} //= 'https://esi.tech.ccp.is/latest';

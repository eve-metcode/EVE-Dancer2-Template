...
#
package EVE::ESI::Client::SkillsApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_skillqueue' } = { 
    	summary => 'Get character&#39;s skill queue',
        params => $params,
        returns => 'ARRAY[GetCharactersCharacterIdSkillqueue200Ok]',
        };
}
# @return ARRAY[GetCharactersCharacterIdSkillqueue200Ok]
#
sub get_characters_character_id_skillqueue {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_skillqueue");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/skillqueue/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetCharactersCharacterIdSkillqueue200Ok]', $response);
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_skills' } = { 
    	summary => 'Get character skills',
        params => $params,
        returns => 'GetCharactersCharacterIdSkillsOk',
        };
}
# @return GetCharactersCharacterIdSkillsOk
#
sub get_characters_character_id_skills {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_skills");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/skills/';
    ...
    my $_response_object = $self->{api_client}->deserialize('GetCharactersCharacterIdSkillsOk', $response);
    return $_response_object;
}

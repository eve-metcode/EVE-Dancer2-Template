...
#
package EVE::ESI::Client::WalletApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_characters_character_id_wallets' } = { 
    	summary => 'List wallets and balances',
        params => $params,
        returns => 'ARRAY[GetCharactersCharacterIdWallets200Ok]',
        };
}
# @return ARRAY[GetCharactersCharacterIdWallets200Ok]
#
sub get_characters_character_id_wallets {
    my ($self, %args) = @_;

    # verify the required parameter 'character_id' is set
    unless (exists $args{'character_id'}) {
      croak("Missing the required parameter 'character_id' when calling get_characters_character_id_wallets");
    }

    # parse inputs
    my $_resource_path = '/characters/{character_id}/wallets/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetCharactersCharacterIdWallets200Ok]', $response);

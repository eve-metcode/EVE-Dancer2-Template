...
#
package EVE::ESI::Client::IncursionsApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_incursions' } = { 
    	summary => 'List incursions',
        params => $params,
        returns => 'ARRAY[GetIncursions200Ok]',
        };
}
...
sub get_incursions {
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetIncursions200Ok]', $response);

...
#
package EVE::ESI::Client::ApiClient;
...
use EVE::ESI::Client::Configuration;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'EVE::ESI::Client::Configuration' ) {
        $config = $_[0];
    } else {
        $config = EVE::ESI::Client::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("EVE::ESI::Client::Object::$class")->new;
        if (ref $data eq "HASH") {

...
#
package EVE::ESI::Client::InsuranceApi;
...
# @param string $x_user_agent Client identifier, takes precedence over User-Agent (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_insurance_prices' } = { 
    	summary => 'List insurance levels',
        params => $params,
        returns => 'ARRAY[GetInsurancePrices200Ok]',
        };
}
# @return ARRAY[GetInsurancePrices200Ok]
#
sub get_insurance_prices {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/insurance/prices/';
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[GetInsurancePrices200Ok]', $response);
